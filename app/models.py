...
class Pessoa(models.Model):
    ...
    mae = models.CharField(max_length=100, verbose_name="Nome da Mae da pessoa")
    data_nasc = models.DateField(max_length=100, verbose_name="Data de Nascimento da pessoa")
    ...
    def __str__(self):
        return f"{self.nome}, {self.pai}, {self.mae}, {self.data_nasc}, {self.email}"
    class Meta:
        verbose_name = "Pessoa"
...
class CursoDisciplina(models.Model):
    carga_horaria = models.CharField(max_length=100, verbose_name="Carga Horária do Curso com suas Disciplinas")
    ...
    def __str__(self):
        return f"{self.carga_horaria}, {self.periodo}"
    class Meta:
